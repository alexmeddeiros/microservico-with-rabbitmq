...
public class PropostaResponseDto {
    ...
    public PropostaResponseDto(Long id, String nome, String sobrenome, String cpf, String telefone, Double renda, String valorSolicitadoFmt, int prazoPagamento, Boolean aprovado, String observacao) {
        this.id = id;
        this.nome = nome;
